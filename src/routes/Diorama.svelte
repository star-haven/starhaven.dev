<script type="ts">
    ...
    const locations = {
        starHaven: "https://noclip.website/embed.html#pm64/hos_03;ShareData=AVN!+Uv9R!TWh2&ULgVpVWWMi5kQ2;UkqCQ8^0m&Vod=p9O6,:Tzu*^Ukd_nV[",
        spmMirrorHall: "https://noclip.website/embed.html#spm/mac_03;ShareData=AAyhLUja}e8(Uqt90C-z=pkbK6B[BbUZX309DlqZV7bVlUm6uDT2Cx@Uc]j0V[",
        ttydThousandYearDoor: "https://noclip.website/embed.html#ttyd/tik_05;ShareData=ALgk8Ugg7uSw/j98(@Oi=U=c?Qvv]4Ul=leS}aT{V38BzT1n_K8gYeVUkJg;WP",
    ...
    const noclipLink = Object.values(locations)[$visitNumber % Object.values(locations).length]
</script>
